...
We use ungetch() but we need to check for overflow - means we need bufp and
BUFSIZE - see the implementation of ungets() below

Building on top of 4.3-6
*/
...
void printUsage()
{
    ...
    printf("example string '1 2 + 2 3 + +' loaded in stack\n");
    printf("\tthis results to (3 5 +) or:\n");
    ungets();
}
